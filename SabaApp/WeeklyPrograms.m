...
+(NSArray*) fromArray1:(NSArray*)programsArray{
	...
	for(DailyProgram* dailyProgram in programsArray){
		NSLog(@" day: %@", [dailyProgram day]);
		NSLog(@" time: %@", [dailyProgram time]);
		NSLog(@" englishDate: %@", [dailyProgram englishDate]);
		NSLog(@" hijriDate: %@", [dailyProgram hijriDate]);
		NSLog(@" program: %@", [dailyProgram program]);
...
//		NSLog(@" program: %@", [dailyProgram program]);
		...
		if([dailyProgram.day compare:@""] == YES){
			NSLog(@"Size: %lu", (unsigned long)weeklyPrograms.count);
